export const populateScheduleWithoutBreaks = (start = 8, end = 16, interval = 30) => {
    ...
    return recursiveScheduler(convertedStartHourToMinutes, convertedEndHourToMinutes, myInterval);
}